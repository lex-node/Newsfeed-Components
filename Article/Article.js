...
const data = [
...

    {
        ...
        secondParagraph: `Pursued by the Empire’s sinister agents, Princess Leia races home aboard her starship, custodian of the stolen plans that can save her people and restore freedom to the galaxy…`,

        thirdParagraph: `It is a dark time for the Rebellion. Although the Death Star has been destroyed, Imperial troops have driven the Rebel forces from their hidden base and pursued them across the galaxy.`
    }
];

/*****************************************
 ARTICLE CREATOR COMPONENT WITH OUTPUT:
 <div class="article">
...
const articleCreator = (obj) => {
    ...
    paraElement2.textContent = obj.secondParagraph;
    ...
    article.appendChild(paraElement1);
    article.appendChild(paraElement2);
    article.appendChild(paraElement3);
    article.appendChild(buttonSpanElement);
